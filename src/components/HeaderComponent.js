...
class Header extends Component
{
  ...
  {
    this.toggleModal();
    //values are retrieved directly from the DOM thanks to the innerRef set up in the form below
  ...
  render()
  {
    return (
      ...
      <React.Fragment>
        ...
        {/* Reacstrap Modal requires the isOpen attribute and the toggle function */}
          ...
          <ModalBody>
            <Form onSubmit={this.handleLogin}>
              <FormGroup>
                ...
                {/* innerRef is like a ref but reactstrap already uses that term
                    for something else, hence the different name*/}
